...
function signup({ email, password, firstName, req }) {
  ...
  if (!email && !password && !firstName) { throw new Error('You must provide an email and password.'); }
...
// function addAttributeToUser({ firstName, req }) {
//   firstName = "herman";
//   return new Promise((resolve, reject) => {
//     resolve(firstName);
//   })
...
// module.exports = { signup, login, addAttributeToUser };
